...
abstract class Hilt_gameFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_gameFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((gameFragment_GeneratedInjector) generatedComponent()).injectgameFragment(UnsafeCasts.<gameFragment>unsafeCast(this));
  }
